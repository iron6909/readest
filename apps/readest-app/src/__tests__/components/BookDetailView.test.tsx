...
describe('BookDetailView More menu', () => {
  ...
  it('keeps local actions and omits account-hosted sharing', () => {
    const { container, getByText, queryByText } = renderView({ onExport: vi.fn() });
    ...
    expect(getByText('Export Book')).toBeTruthy();
